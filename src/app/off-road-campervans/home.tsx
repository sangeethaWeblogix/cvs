...
const OR_FAQ = [
  ...
  { q: "Do I need a special vehicle to tow an off road campervan?", a: "Yes. Off road campervans are heavier and wider than standard campervans. You'll need a high-capacity 4WD with a tow bar rated to the campervan'sGVM. Always check the campervan'sGVM and the tow vehicle's GVM and tow rating before purchasing." },
