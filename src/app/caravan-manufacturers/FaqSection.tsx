...
const faqData: FaqItem[] = [
  {
    ...
    content: (
      <>
        <h4>What types of campervans does Everest Caravans specialize in?</h4>
        <p>
        ...
        <h4>Can I customize my campervan with Everest Caravans?</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <h4>What range of campervans does Orbit Caravans offer?</h4>
        <p>
          Orbit Caravans offers luxury off-road campervans like{" "}
          <Link
