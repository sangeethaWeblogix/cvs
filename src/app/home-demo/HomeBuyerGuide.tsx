          ...
          <div className="hbg-why-cards-wrap">
            <div className="hbg-why-grid">
              ...
              <div className="hbg-why-card">
                ...
                <p className="hbg-why-card-desc">Browse new and used campervans for sale from trusted dealers and private sellers across Australia.</p>
              </div>
              ...
              <div className="hbg-why-card">
                ...
                <div className="hbg-why-card-sep" />
                <p className="hbg-why-card-desc">Compare campervan prices, layouts and specifications side by side to find the right fit.</p>
              </div>
